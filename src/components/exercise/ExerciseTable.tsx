        ...
        <Table>
          <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
            <TableRow>
              ...
              <TableCell isHeader className="px-5 py-3 font-medium text-start text-theme-xs text-gray-500 dark:text-gray-400">Tipo de Questão</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-start text-theme-xs text-gray-500 dark:text-gray-400">Plano de Aula</TableCell>
          ...
          <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
            {exercises.map((exercise) => (
              <TableRow key={exercise._id}>
                ...
                <TableCell className="px-4 py-3 text-start text-gray-500 text-theme-sm dark:text-gray-400">{exercise.showAnswer ? "Sim" : "Não"}</TableCell>
                ...
                <TableCell className="px-4 py-3 text-start text-gray-500 text-theme-sm dark:text-gray-400">{typeLabels[exercise.type] || "Tipo Desconhecido"}</TableCell>
                <TableCell className="px-4 py-3 text-start text-gray-500 text-theme-sm dark:text-gray-400">{getLessonPlanName(exercise.lesson_plan_id)}</TableCell>
